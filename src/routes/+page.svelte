        ...
        <div class="flex flex-col gap-y-5 lg:gap-y-6 absolute top-1/4 lg:top-1/3 left-24 text-white z-10 w-4/6 lg:w-3/5">
            ...
            <Dialog.Root>
                ...
                <Dialog.Content class="h-auto lg:min-w-[1024px]">
                    <iframe title="Introduction Video" class="w-full h-full p-2 aspect-video" src="https://www.youtube.com/embed/bLlW7eyB3cQ?si=j9D5Nlk-HkEE6auE" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </Dialog.Content>
            </Dialog.Root>
        </div>
