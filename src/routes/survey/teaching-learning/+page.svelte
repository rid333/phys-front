<script lang="ts">
    ...
    const pageName = "Teaching & Learning Survey";
</script>
...
<svelte:head>
    ...
    <meta
        name="description"
        content="Teaching & Learning Survey, Department of Physics Hasanuddin University"
    />
...
<div class="relative max-w-5xl m-auto">
    <div class="bg-white -mt-20 -mb-5 z-30 lg:mb-20 shadow-lg p-8 lg:p-16">
        ...
        <div class="max-w-full text-black text-base lg:text-lg font-medium leading-relaxed text-justify">
            <img
                class={`object-cover`}
                src="https://18.136.124.23.nip.io/media/New%20survey%20teaching%20Learning%20odd%20and%20even%20semester%20in%20A.Y%2024-25-1024x725.jpg"
                alt="Survey"
            />
        </div>
    </div>
